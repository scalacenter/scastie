...
package object components {
  ...
  implicit val reusabilityBaseInputs: Reusability[BaseInputs] = Reusability.byRefOr_==
  ...
  implicit val sbtScalaTargetReuse: Reusability[SbtScalaTarget] = Reusability.byRefOr_==
  ...
  implicit val editorModeReuse: Reusability[EditorMode] = Reusability.byRefOr_==

  implicit val reusabilityEditorModeToCallback: Reusability[EditorMode => Callback] = Reusability.byRefOr_==
