...
case class UserResourceUpdated(login: String, uuid: String, update: Int)
    extends ResourcePage

case class EmbeddedAnonymousResource(uuid: String) extends ResourcePage
case class EmbeddedUserResource(login: String, uuid: String)
    extends ResourcePage
case class EmbeddedUserResourceUpdated(login: String,
                                       uuid: String,
                                       update: Int)
    extends ResourcePage
