...
class LineMapperSpecs extends AnyFunSuite {
  ...
  test("mapping with simple instrumentation") {
    ...
    val code1 = """|import _root_.com.olegych.scastie.api.runtime.*
                   ...
                   |val $t = println("test1"); 
                   |$doc.binder(_root_.com.olegych.scastie.api.runtime.Runtime.render($t), 0, 16);
                   |$doc.endStatement();
                   |$t}
                   |val y = 1
                   |scala.Predef.locally {
                   ...
                   |val $t = println("test2"); 
                   |$doc.binder(_root_.com.olegych.scastie.api.runtime.Runtime.render($t), 26, 42);
                   |$doc.endStatement();
                   |$t}
                   |}
                   |""".stripMargin
  ...
  test("mapping with experimental imports extracted") {
    ...
    val code1 =
      """|import _root_.com.olegych.scastie.api.runtime.*
         ...
         |val $t = println("test"); 
         |$doc.binder(_root_.com.olegych.scastie.api.runtime.Runtime.render($t), 0, 15);
         |$doc.endStatement();
         |$t}
         |val x = 1
         |}
  ...
  test("mapping with multiline expressions") {
    ...
    val code1 = """|import _root_.com.olegych.scastie.api.runtime.*
                   ...
                   |val $t = println:
                   |  "multiline"; 
                   |$doc.binder(_root_.com.olegych.scastie.api.runtime.Runtime.render($t), 0, 25);
                   |$doc.endStatement();
                   |$t}
                   |val x = 1
                   |}
  ...
  test("mapping with empty lines and comments") {
    ...
    val code1 = """|import _root_.com.olegych.scastie.api.runtime.*
                   ...
                   |val $t = println("test"); 
                   |$doc.binder(_root_.com.olegych.scastie.api.runtime.Runtime.render($t), 15, 31);
                   |$doc.endStatement();
                   |$t}
                   |// Comment 2
                   |val x = 1
  ...
  test("single line code") {
    ...
    val code1 = """|import _root_.com.olegych.scastie.api.runtime.*
                   ...
                   |val $t = println(42); 
                   |$doc.binder(_root_.com.olegych.scastie.api.runtime.Runtime.render($t), 0, 11);
                   |$doc.endStatement();
                   |$t}
                   |}
                   |""".stripMargin
  ...
  test("complex real-world example") {
    ...
    val code1 = """|import _root_.com.olegych.scastie.api.runtime.*
                   ...
                   |  println(s"Processing: $x")
                   |}; 
                   |$doc.binder(_root_.com.olegych.scastie.api.runtime.Runtime.render($t), 25, 75);
                   |$doc.endStatement();
                   |$t}
                   |
                   |val result = data.map(_ * 2)
                   ...
                   |$doc.binder(_root_.com.olegych.scastie.api.runtime.Runtime.render($t), 106, 120);
                   |$doc.endStatement();
                   |$t}
                   |}
                   |""".stripMargin
  ...
  test("mapping with multiple identical expressions") {
    ...
    val code1 = """|import _root_.com.olegych.scastie.api.runtime.*
                   ...
                   |val $t = println("test"); 
                   |$doc.binder(_root_.com.olegych.scastie.api.runtime.Runtime.render($t), 25, 40);
                   |$doc.endStatement();
                   |$t}
                   |val z = 3
                   |}
