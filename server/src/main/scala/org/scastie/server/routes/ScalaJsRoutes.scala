...
class ScalaJsRoutes(dispatchActor: ActorRef)(
  ...
  val routes: Route = encodeResponseWith(Gzip)(
    concat(
      snippetIdEnd(Shared.scalaJsHttpPathPrefix, Js.targetFilename)(sid =>
        complete(
      ...
      snippetIdEnd(Shared.scalaJsHttpPathPrefix, Js.sourceFilename)(sid =>
        complete(
      ...
      snippetIdEnd(Shared.scalaJsHttpPathPrefix, Js.sourceMapFilename)(sid =>
        complete(
