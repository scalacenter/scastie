...
class Document protected () extends js.Object {
  ...
  def getRange(from: Position,
               to: Position,
               separator: UndefOr[String]): String = js.native
  def replaceRange(replacement: String,
                   from: Position,
                   to: Position,
  ...
  def replaceSelection(replacement: String, select: UndefOr[String]): Unit =
    js.native
  def replaceSelections(replacements: Array[String],
                        select: UndefOr[String]): Unit = js.native
  ...
  def setCursor(pos: Position | Int,
                ch: UndefOr[Int] = undefined,
                options: UndefOr[js.Object] = undefined): Unit = js.native
  def setSelection(anchor: Position,
                   head: UndefOr[Position],
                   options: UndefOr[js.Object]): Unit = js.native
  ...
  def extendSelection(from: Position,
                      to: UndefOr[Position],
                      options: UndefOr[js.Object]): Unit = js.native
  def extendSelections(heads: Array[Position],
                       options: UndefOr[js.Object]): Unit = js.native
  ...
  def markText(from: Position,
               to: Position,
               options: UndefOr[js.Object]): TextMarker = js.native
  ...
  def addLineClass(line: Int | LineHandle,
                   where: String,
                   `class`: String): LineHandle = js.native
  def removeLineClass(line: Int | LineHandle,
                      where: String,
                      `class`: String): LineHandle = js.native
  def addLineWidget(line: Int | LineHandle,
                    node: Element,
